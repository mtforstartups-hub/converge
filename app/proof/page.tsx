...
export default function ProofPage() {
  return (
    <main className="min-h-screen">
      ...
      <section className="py-10 md:py-20 bg-parchment">
        <div className="mx-auto max-w-95/100 md:max-w-5/6 px-4 md:px-6 lg:px-10">
          <div className="space-y-2 md:space-y-4">
            <div>
              <p className="text-[10px] md:text-xs uppercase tracking-[0.3em] font-bold text-primary/40 mb-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16">
              {stats.map((stat, index) => (
                <div key={index} className="space-y-6 group">
                  <div className="w-full h-px bg-primary/10 group-hover:bg-accent/40 transition-colors duration-500" />
      ...
      <section className="py-10 md:py-20 bg-deep-slate">
        <div className="mx-auto max-w-95/100 md:max-w-5/6 px-4 md:px-6 lg:px-10">
          <div className="space-y-4 md:space-y-8">
            <div>
              <p className="text-[10px] md:text-xs uppercase tracking-[0.3em] font-bold text-accent mb-2">
              ...
              {testimonials.map((t, i) => (
                <LeftBorderedCard key={i} type="primary" className="">
                  <div className="flex flex-col h-full justify-between gap-4 md:gap-8">
                    <p className="text-base md:text-lg text-font italic leading-relaxed">
                      &ldquo;{t.quote}&rdquo;
                    </p>
                    <div className="space-y-1">
                      <p className="text-sm md:text-base text-font/80">
                        {t.author}
                      </p>
      ...
      {/* Bottom CTA Section */}
      <section className="py-10 md:py-20 bg-[#0c121e]">
