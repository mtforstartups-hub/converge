...
export default function NotFound() {
  return (
    <div className="bg-midnight min-h-[70vh] flex flex-col relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-150 h-150 bg-verified/5 rounded-full blur-[100px] pointer-events-none" />
      ...
      <section className="flex-1 flex flex-col items-center justify-center px-4 md:px-6 py-20 mx-auto max-w-[95%] md:max-w-[83.333%] relative z-10 w-full">
        <div className="flex flex-col items-center gap-8 max-w-2xl text-center">
          ...
          <div className="space-y-6">
            ...
            <h1 className="font-display text-4xl md:text-5xl lg:text-6xl text-parchment tracking-wider">
              Page Not Found
            </h1>

            <p className="font-sans text-steel text-lg md:text-xl max-w-lg mx-auto leading-relaxed">
              We couldn&apos;t locate the requested endpoint. It may have been
              archived, moved, or never existed in our system.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-6 w-full sm:w-auto">
            ...
            >
              ...
              <ArrowRight
                size={18}
                className="group-hover:translate-x-1 transition-transform duration-300 text-steel group-hover:text-parchment"
              />
            </Link>
          </div>
        </div>
