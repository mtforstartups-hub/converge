    ...
    <section className="w-full bg-[#E9E6E1]">
      <div className="max-w-95/100 md:max-w-5/6 mx-auto px-4 sm:px-6 lg:px-10 py-16 lg:py-24 grid lg:grid-cols-2 gap-10 lg:gap-16 items-start">
        ...
        <div>
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-primary  mb-6 font-sans">
            Your team doesn’t have a data entry problem. They have a fact
            maintenance problem.
          </h2>

          <p className="text-lg text-primary/70 mb-5 max-w-xl">
          ...
          <p className="text-lg text-primary/70 mb-6 max-w-xl">
        ...
        <div className="bg-[#2F4156] text-white rounded-2xl p-5 sm:p-6 lg:p-8">
          ...
          {/* Bottom Highlight */}
          <div className="mt-6 bg-accent/40 border border-accent rounded-lg p-4 text-sm md:text-base font-semibold text-white/80">
