...
export default function BottomCta() {
  ...
  return (
    <section className="bg-[#16263A]">
      <div className="max-w-95/100 md:max-w-5/6 text-parchment text-xl md:text-2xl lg:text-3xl xl:text-5xl mx-auto px-4 md:px-10 py-10 md:py-20 font-medium text-center">
        {/* Animated text */}
