...
const faqs = [
  {
    question: "Does Converge work for non-QM and unconventional structures?",
    answer:
      "Yes. The Policy Engine encodes your policy — including non-QM exception logic — and the Reasoning layer handles unusual entity and collateral structures.",
  },
  {
    question: "How does it handle sponsor recurrence?",
    answer:
      "CreditOS recognizes when a sponsor has been underwritten before and surfaces the prior deals, prior approvals, and prior exceptions — without manual lookup.",
  },
  {
    question: "Can our credit committee see the reasoning?",
    answer:
      "Every decision is traceable to its source document and its policy clause. Committee memos pull from the same audit trail.",
  },
];

export default function PrivateLendersFAQ() {
