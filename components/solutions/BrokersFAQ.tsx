...
const faqs = [
  {
    question: "Does this work for multiple lender partners?",
    answer:
      "Yes. Loan Officer Intelligence supports multi-lender deployments — each lender's submission requirements can be encoded so the package generated matches what they expect.",
  },
  {
    question: "What does it cost for a small shop?",
    answer:
      "Pricing for broker and loan officer teams is volume-based. See the Pricing page for tier detail or talk to us about a custom quote.",
  },
  {
    question: "Can our borrowers see the request list directly?",
    answer:
      "Yes. Borrower portals can be enabled so the request list goes directly to the borrower, with status visible to you in real time.",
  },
];
