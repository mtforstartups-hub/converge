...
const faqs = [
  {
    question: "How does Converge support NCUA exam readiness?",
    answer:
      "Every credit decision is auditable end-to-end. Examiners can trace any underwriting outcome back to the source document, the policy clause, and the model version in effect. Documentation is built in, not bolted on.",
  },
  {
    question: "Does it integrate with our LOS?",
    answer:
      "Converge integrates with the LOS systems most common in credit unions, including Encompass, ACES, and custom in-house systems. Implementation typically takes four to six weeks.",
  },
  {
    question: "Is data hosted in the US?",
    answer:
      "Yes. All data is hosted in US regions only, with single-tenant options available for institutions that require them. See the Security page for full detail.",
  },
];

export default function CreditUnionsFAQ() {
