...
export default function BottomCta({
  ...
  return (
    <section
      className={`${type === "primary" ? "bg-deep-slate" : "bg-parchment"}`}
    >
      <div
        className={`max-w-95/100 md:max-w-5/6 text-xl md:text-2xl lg:text-3xl xl:text-5xl mx-auto px-4 md:px-10 py-10 md:py-20 font-bold text-center ${
          type === "primary" ? "text-parchment" : "text-charcoal"
        }`}
      >
        {/* Animated text */}
